...
function VideoVisualizer(_parent, _conditions, _audio) {
  ...
  this.videoPlaceholder = $(
    '<div id="video-placeholder" class="container">\
      <img width="400" src="configs/images/play.jpg" alt="Play image" style="opacity:0.3">\
      <div class="centered">Lorsque vous appuyez sur l\'un des boutons "Play" ci-dessous, une vidéo s\'affiche ici.</div>\
    </div>'
  );
  ...
  this.conditions.forEach(function (condition, i) {
    ...
    playerHtml = $('<video width="480" id="'+condition.getId()+'" class="video-js"> <source src="'+condition.getFilepath()+'"> </video>').get(0);
